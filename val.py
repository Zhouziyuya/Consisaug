...
def parse_opt():
    ...
    # parser.add_argument('--weights', nargs='+', type=str, default='/home/zhouziyu/sensezzy/polypdetect/yolov5/runs/train/public_100_conslr_0.00001initlr_postive2/weights/best.pt', help='model path(s)')
    parser.add_argument('--weights', nargs='+', type=str, default='/home/zhouziyu/sensezzy/polypdetect/yolov5/runs/train/public_consis_100_coslr_0.00001initlr_postive_woconf_l2s/weights/best.pt', help='model path(s)')
